    ...
    public static class OcclusionMetallicRoughnessConverter
    {
        ...
        private static Material Importer
        {
            get
            {
                if (_importer == null)
                {
                    _importer = new Material(ShaderLoader.Find("Hidden/UniGLTF/StandardMapImporter"));
                }
                return _importer;
            }
        }
        ...
        private static Material Exporter
        {
            get
            {
                if (_exporter == null)
                {
                    _exporter = new Material(ShaderLoader.Find("Hidden/UniGLTF/StandardMapExporter"));
                }
                return _exporter;
            }
        }
